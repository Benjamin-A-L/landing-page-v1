    ...
    <main>
      ...
      <div class="mainWrapper">
          ...
          <div className="whats_the_catch">
            ...
            <div className="catch_list">
              ...
              <ul className='catch_list_wrapper'>
                ...
                <li className="catch_list_item">Referirnos a alguien que puede beneficiar de nuestros servicios, en caso de lo veas pertinente</li>
              </ul>
            </div>
          </div>
        </section>
        <div className="line-break" />
        <section className='solution de-que-es'>
          <h1>De que se trata?</h1>
          <p>El tema aqui es un plan para aumentar la cantidad y mejorar la conversión de visitas por medios web. <br/>
          ...
          Ademas de esto, tambien tenemos un enfoque en aumentar la frecuencia de tus clientes, para que puedas tener una fuente de ingresos mas recurrentes.
          </p>
        </section>
        <section className="solution">
          <div className="solution_webdev">
            ...
            <div className="paragraph-wrapper solution-block">
              <StaticImage src="../images/ssg-host-flow.png" className="code-img slide-L-target solution-img" alt="code editor, with gatsby code"></StaticImage>
              <p className="slide-R-target">Sitios web extremadamente rapidos, gracias a un modelo de generación estatica</p>
            </div>
            <div className='insights-wrapper solution-block'>
              <p className="slide-L-target">Optimización, accesibilidad en multiples dipositivos y velocidad que verificamos con <a target="_blac" href='https://pagespeed.web.dev'>google page speed insights</a></p>
          ...
          <div className="mail-prismic-wrapper fade-in">
            <div className="solution_prismic solution-block">
              ...
              <p className="slide-R-target">Podras editar el contenido del sitio a gusto, sin necesidad de escribir codigo gracias a que integramos de <a href="https://prismic.io" target="_blank">prismic.io</a></p>
            </div>
            <div className="solution_email solution-block">
              <p className="slide-L-target">Mejoraremos tu retención de clientes, informadolos de tus offertas y descuentos con correos automatizados</p>
              <StaticImage src="../images/mailerlite-logo" className="email-img slide-R-target solution-img" alt="logo email"></StaticImage>
            </div>
          </div>
          <div className="solution_GMB solution-block">
            ...
            <p className="slide-R-target">Incrementamos busquedas locales con optimización de GMB (Google my business)</p>
          </div>
        </section>
        <div className="line-break" />
        <section className="audience">
          ...
          <div className="map-imbed" dangerouslySetInnerHTML={{ __html: '<iframe src="https://www.google.com/maps/embed?pb=!1m12!1m8!1m3!1d25548.267636835168!2d-73.07018214282225!3d-36.829698205105316!3m2!1i1024!2i768!4f13.1!2m1!1sbares!5e0!3m2!1ses-419!2scl!4v1700429366341!5m2!1ses-419!2scl" width="100%" height="560" style="border: 0; border-radius: 14px; box-shadow: rgba(2, 1, 0, 0.14) 0px 1px 41px 2px; margin-bottom: 10px" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>' }} />
        </section>
